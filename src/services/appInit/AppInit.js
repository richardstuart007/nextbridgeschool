...
export default function AppInit() {
  ...
  function Init_Storage() {
    ...
    //
    sessionStorageSet({ caller: debugModule, itemName: 'App_Server', itemValue: g_Server })
    sessionStorageSet({ caller: debugModule, itemName: 'App_Database', itemValue: g_Database })
    sessionStorageSet({ caller: debugModule, itemName: 'App_URL', itemValue: g_URL })
    //
    //  SignedIn Status
    //
    sessionStorageSet({ caller: debugModule, itemName: 'User_SignedIn', itemValue: false })
    //
    //  Quiz
    //
    sessionStorageSet({ caller: debugModule, itemName: 'Page_Quiz_Owner', itemValue: '' })
    sessionStorageSet({ caller: debugModule, itemName: 'Page_Quiz_OwnerGroup', itemValue: '' })
    //
    //  Data Option Owners
    //
